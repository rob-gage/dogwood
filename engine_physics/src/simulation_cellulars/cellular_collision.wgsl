...
fn extract_cellular_collision_occupancy(
    ...
    let cell_start: u32 = (physical.y * parameters.buffered_tile_size.x + physical.x) * CELL_COUNT_PER_TILE;
    ...
    for (var cell = 0u; cell < CELL_COUNT_PER_TILE; cell++) {
        ...
        } else if identifier != EMPTY_MATERIAL_IDENTIFIER && form == CELLULAR_DYNAMIC_MATERIAL_FORM {
