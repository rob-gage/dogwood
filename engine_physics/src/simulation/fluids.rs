...
pub struct Fluids {
    ...
    /// Integrates and collides authoritative particles
...
impl Fluids {
    ...
    pub fn new(
        ...
        Self {
            ...
            move_pipeline: pipeline("move_fluid_particles", "fluid movement pipeline"),
    ...
    pub fn simulate(
        ...
        self.dispatch(&mut encoder, &self.move_pipeline, self.particle_capacity,
...
mod tests {
    ...
    fn fluid_edits_move_across_negative_tile_boundary_and_reuse_capacity() {
        ...
        let crossed_cell_index: usize = 4 * 8 + 1;
        fluid.apply_edits(
            &accelerator,
