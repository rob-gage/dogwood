...
pub struct CellularDynamic {
    ...
    /// Resolved kinematics before they are committed to persistent storage
    kinematics_output: AcceleratorBuffer,
...
impl CellularDynamic {
    ...
    pub fn new(
        ...
        let appearances_output: AcceleratorBuffer =
            accelerator.allocate::<u32>(buffered_cell_count as usize);
        let kinematics_output: AcceleratorBuffer =
            accelerator.allocate::<[f32; 4]>(buffered_cell_count as usize);
        ...
        let bind_group_layout: wgpu::BindGroupLayout = device.create_bind_group_layout(
            &wgpu::BindGroupLayoutDescriptor {
                ...
                entries: &[
                    ...
                    Self::cellular_dynamic_storage_layout_entry(2, true),
                    ...
                    Self::cellular_dynamic_storage_layout_entry(7, false),
        ...
        let bind_group: wgpu::BindGroup = device.create_bind_group(
            &wgpu::BindGroupDescriptor {
                ...
                entries: &[
                    ...
                    wgpu::BindGroupEntry {
                        binding: 5,
                        resource: kinematics_output.wgpu_buffer().as_entire_binding(),
                    },
                    wgpu::BindGroupEntry {
                        binding: 6,
    ...
    pub fn simulate_cellular_dynamic_tick(
        ...
        let kinematics_size: u64 = u64::from(self.buffered_cell_count) * 16;
        ...
        encoder.copy_buffer_to_buffer(
            self.kinematics_output.wgpu_buffer(),
            0,
